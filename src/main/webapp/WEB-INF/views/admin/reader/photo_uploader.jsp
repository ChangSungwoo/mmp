...
.pop_container .drag_area .bg{display:block;position:absolute;top:0;left:0;width:341px;height:129px;background:#fdfdfd url(/css/img/bg_drag_image.png) 0 0 no-repeat}
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
    	<!-- content -->
		<form id="editor_upimage" name="editor_upimage" action="/admin/reader/readerImageUpload" method="post" enctype="multipart/form-data" onSubmit="return false;">
        <div id="pop_content2">
    ...
    <div id="pop_footer">
	    <div class="btn_area">
            <a href="#"><img src="/css/img/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm" name="btn_confirm"></a>
            <img src="/css/img/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel" name="btn_cancel">
        </div>
    </div>
    <!-- //footer -->
</div>
	...
	<!-- JS Customization -->
	<script type="text/javascript" src="/js/admin/reader/photo_uploader.js"></script>
	<script type="text/javascript" src="/js/editor/lib/jindo.min.js" charset="utf-8"></script>
	<script type="text/javascript" src="/js/editor/lib/jindo.fileuploader.js" charset="utf-8"></script>
