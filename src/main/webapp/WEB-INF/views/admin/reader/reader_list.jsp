...
<body>
	...
	<div class="wrapper">
		...
		<jsp:include page="/WEB-INF/views/admin/include/includeNavi.jsp" flush="true">
			<jsp:param name="thisName" value='<%=java.net.URLEncoder.encode("읽을거리 목록조회")%>'/>
				...
				<div class="col-md-12">
					...
					<div class="panel panel-grey margin-bottom-40">
						<div class="panel-heading">
							<h3 class="panel-title"><i class="fa fa-gear"></i>읽을거리 조회</h3>
						</div>
									...
									<c:when test="${fn:length(list) > 0}">
										<c:forEach items="${list}" var="row">
											<tr>
												...
												<td><a href="javascript:readerDetail('${row.readerSeq}');">${row.readerTitle}</a></td>
												<td>
													<c:choose>
	...
	<!-- JS Customization -->
	<script type="text/javascript" src="/js/admin/reader/reader_list.js"></script>
	<!-- JS Page Level -->
