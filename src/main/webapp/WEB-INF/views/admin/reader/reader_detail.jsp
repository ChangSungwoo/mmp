...
<body>
	<div class="wrapper">
		...
		<jsp:include page="/WEB-INF/views/admin/include/includeNavi.jsp" flush="true">
			<jsp:param name="thisName" value='<%=java.net.URLEncoder.encode("읽을거리 상세조회")%>'/>
							...
							<div class="row">
								<section class="col col-3">
									...
									<div class="inline-group">
										<label class="radio"><input type="radio" name="useYn" id="useYn" value="Y" <c:if test="${reader.useYn eq 'Y' }"> checked </c:if>><i class="rounded-x"></i>노출</label>
										<label class="radio"><input type="radio" name="useYn" id="useYn" value="N" <c:if test="${reader.useYn eq 'N' }"> checked </c:if>><i class="rounded-x"></i>대기</label>
									</div>
								</section>
								<section class="col col-3">
									<label class="label">대표 이미지</label>
									<label class="inline-group">
										<img src="/img/common/no_image.jpeg" alt="" width="150">
										<button type="button" id="btnSelectImg" name="btnSelectImg" class="btn-u">찾기</button>
									</label>
								</section>
								<section class="col col-6">
									<label class="label">동영상 URL</label>
									<label class="input">
										<input type="text" name="movieUrl" id="movieUrl" value="${reader.movieUrl}">
									</label>
								</section>
							</div>
							<div class="row">
								<section>
									...
									<label class="input state-success">
										<input type="text" name="readerTitle" id="readerTitle" value="${reader.readerTitle}">
									</label>
								</section>
							</div>
							<div class="row">
								<section>
									...
									<textarea name="ir1" id="ir1" rows="10" style="width:100%; height:412px; ">${reader.readerContent}</textarea>
								</section>
							</div>
						</fieldset>
						<footer>
	...
	<!-- JS Customization -->
	<script type="text/javascript" src="/js/admin/reader/reader_detail.js"></script>
