					...
					<div class="col-md-4 md-margin-bottom-50">
						<div class="ms-showcase2-template">
							...
							<div class="master-slider ms-skin-default" id="masterslider">
								<div class="ms-slide">
									<img class="ms-brd" src="/img/blank.gif" data-src="/img/movie/box001_1.jpg" alt="lorem ipsum dolor sit">
									<img class="ms-thumb" src="/img/movie/box001_1.jpg" alt="thumb">
								</div>
								<div class="ms-slide">
									<img src="/img/blank.gif" data-src="/img/movie/box001_2.jpg" alt="lorem ipsum dolor sit">
									<img class="ms-thumb" src="/img/movie/box001_2.jpg" alt="thumb">
								</div>
								<div class="ms-slide">
									<img src="/img/blank.gif" data-src="/img/movie/box001_3.jpg" alt="lorem ipsum dolor sit">
									<img class="ms-thumb" src="/img/movie/box001_3.jpg" alt="thumb">
								</div>
							</div>
							<!-- End Master Slider -->
						</div>
