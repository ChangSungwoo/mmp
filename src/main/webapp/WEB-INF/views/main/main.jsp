...
<head>
	...
	<link rel="stylesheet" href="/css/headers/header-v7.css">
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown active">
								...
								<ul class="dropdown-menu">
									...
									<li class="active"><a href="page_home12.html">Option 15: Home Left Sidebar</a></li>
									<li><a href="page_home13.html">Option 15: Home Right Sidebar</a></li>
