	...
	<!--=== End Header v8 ===-->
		...
		<div class="container content">
			<div class="row portfolio-item margin-bottom-50">
				<!-- Carousel -->
				<c:choose>
					<c:when test="${(reader.readerDiv) eq 1}">
						<div class="col-md-7">
					...
					<c:when test="${(reader.readerDiv) eq 2}">
						<div class="col-md-7">
							<div class="carousel slide carousel-v1" id="myCarousel">
								<div class="carousel-inner">
									<div class="item active">
										<iframe frameborder="0" width="640" height="360" src="${reader.movieUrl}" allowfullscreen></iframe>
									</div>
								</div>
							</div>
						</div>
